...
describe('contentType.parse(req)', function () {
  ...
  it('should reject objects without headers property', function () {
    assert.throws(contentType.parse.bind(null, {}), /content-type header missing from object/)
  })

  it('should reject missing content-type', function () {
    var req = {headers: {}}
    assert.throws(contentType.parse.bind(null, req), /content-type header missing from object/)
  })
})
...
describe('contentType.parse(res)', function () {
  ...
  it('should reject missing content-type', function () {
    ...
    assert.throws(contentType.parse.bind(null, res), /content-type header missing from object/)
  })
})
